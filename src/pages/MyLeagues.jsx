...
import { Link2, X, LogOut } from 'lucide-react';
  ...
  const renderTabContent = (tabId) => {
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 space-y-4">
        ...
        <button 
          className="px-6 py-3 bg-gray-500 text-white rounded-lg cursor-not-allowed opacity-50"
          disabled
        >
          Coming Soon
        </button>
        <p className="text-sm text-gray-400">
          Support for {tabId.charAt(0).toUpperCase() + tabId.slice(1)} coming soon
        </p>
      </div>
    );
  };
