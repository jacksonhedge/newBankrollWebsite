...
const Platforms = () => {
  ...
  const platforms = [
    { 
      ...
      name: 'PrizePicks (18+)', 
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/assets/prizepicks.png',
    ...
    { 
      ...
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/assets/draftkingsFantasy.png',
    ...
    { 
      ...
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/assets/fanduel.png',
      legalStates: 'Most US states',
    ...
    { 
      ...
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/assets/underdog.jpeg',
      legalStates: 'Most US states',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/assets/myPrizeLogo.jpeg',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/assets/betmgm.png',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/assets/caesarsCasino.png',
      legalStates: 'MI, NJ, PA, WV',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/assets/pokerstars.png',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/assets/bet365logo.png',
    ...
    { 
      ...
      name: 'WSOP Casino (21+)', 
      category: 'CASINO', 
      logo: '/newBankrollWebsite/assets/WSOP.png',
      legalStates: 'MI, NJ, PA',
