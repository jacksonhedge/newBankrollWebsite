...
const Platforms = () => {
  ...
  const platforms = [
    { 
      ...
      name: 'PrizePicks (18+)', 
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/images/prizepicks.png',
    ...
    { 
      ...
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/images/draftkingsFantasy.png',
    ...
    { 
      ...
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/images/fanduel.png',
      legalStates: 'Most US states',
    ...
    { 
      ...
      category: 'FANTASY', 
      logo: '/newBankrollWebsite/images/underdog.jpeg',
      legalStates: 'Most US states',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/images/myPrizeLogo.jpeg',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/images/betmgm.png',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/images/caesarsCasino.png',
      legalStates: 'MI, NJ, PA, WV',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/images/pokerstars.png',
    ...
    { 
      ...
      category: 'CASINO', 
      logo: '/newBankrollWebsite/images/bet365logo.png',
    ...
    { 
      ...
      name: 'WSOP Casino (21+)', 
      category: 'CASINO', 
      logo: '/newBankrollWebsite/images/WSOP.png',
      legalStates: 'MI, NJ, PA',
